...
import { User, Chat } from "../model/app.models";
...
export class ChatService {
  ...
  constructor(private db: AngularFirestore) {
    ...
    this.users = db.collection<User>(firebaseConfig.users_endpoint);
    this.chats = db.collection<Chat>(firebaseConfig.chats_endpoint);
  }
